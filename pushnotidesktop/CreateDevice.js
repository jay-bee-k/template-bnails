var applicationServerPublicKey = 'BNEttR2jhwtAFwE8zPVaZPGOe4X15sEyERb591RccoSx2QTDWSD1X35ODFHCqtWb8ltMQvkjgfWd9hoK-WWiezg';
    ...
    navigator.serviceWorker.ready.then(function (reg) {
        ...
        reg.pushManager.subscribe(subscribeParams)
            .then(function (subscription) {
                ...
                $.ajax({
                    type: "POST",
                    url: "/Admin/Login/InsertDevicetoken",
